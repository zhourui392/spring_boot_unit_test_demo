...
public class Lang {
     ...
     * @return 数组对象
     */
    public static <T> T[] array(@SuppressWarnings("unchecked") T... eles) {
        return eles;
    }
     ...
     * @return 列表对象
     */
    public static <T> ArrayList<T> list(@SuppressWarnings("unchecked") T... eles) {
     ...
     * @return 集合对象
     */
    public static <T> Set<T> set(@SuppressWarnings("unchecked") T... eles) {
