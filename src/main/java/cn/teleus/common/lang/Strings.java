...
public class Strings {
     ...
     * @return 拼接好的字符串
     */
    public static <T> String join(String sp, @SuppressWarnings("unchecked") T... array) {
     ...
     * @return 人类容易阅读的字符串
     */
    private static String formatSizeForRead(long size, double szu) {
        if (size < szu) {
    ...
    /**
     * 过滤搜索条件，如果为空字符串返回null
     * @param search
     * @return
     */
    public static String trimStringSearch(String search){
    	search = Strings.trim(search);
    	return Strings.isBlank(search) ? null : search;
    }
